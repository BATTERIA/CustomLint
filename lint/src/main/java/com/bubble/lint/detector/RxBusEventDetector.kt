...
class RxBusEventDetector : BaseDetector(), Detector.UastScanner {
    companion object {
        private const val explanation = "RxBus事件需分类放在com.bubble.lint.videoliveplayer.ui.roomv3.base.events包下"
        ...
        private val postEventMethods = listOf(
            "com.bubble.lint.videoliveplayer.ui.roomv3.base.rxbus.IRxBusManager.postEvent",
            "com.bubble.lint.videoliveplayer.ui.roomv3.base.viewmodel.IRoomCommonBase.postMainEvent",
            "com.bubble.lint.videoliveplayer.ui.roomv3.base.viewmodel.IRoomCommonBase.postBackgroundEvent"
        )
        private const val eventPackage = "com.bubble.lint.videoliveplayer.ui.roomv3.base.events"
    }
